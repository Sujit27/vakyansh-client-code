...
def flaskresponse(input,language,input_format,output_format): 
    ...
    grpc_channel = grpc.insecure_channel('35.81.103.117:50051', options=[('grpc.max_send_message_length', MAX_MESSAGE_LENGTH),('grpc.max_receive_message_length', MAX_MESSAGE_LENGTH)])
